...
function updateGalleryValueCheck(){
	var title = document.updateGallery.title.value;
	
	
	if(title.length == 0 || title.trim().length == 0){
		alert("제목을 입력하세요");
		document.updateGallery.title.focus();
		return false;
	}
...
<div class="main_gallery">
	<br />
		...
		<div align="left" >
			<form action="/lance/gallery/update.it" method="post" enctype="multipart/form-data" name="updateGallery" onsubmit="return updateGalleryValueCheck()">
			<table>
				<tr>
